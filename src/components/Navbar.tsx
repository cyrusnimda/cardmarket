...
const NavBar = () => {
	...
	v-8.565C306.52,285.352,302.491,281.322,297.52,281.322z"/>
                        ...
                        <ul className="hidden md:flex px-4 ml-8 mr-auto font-semibold font-heading space-x-12">
                            <li><Link className="hover:text-golden" href="/">Home</Link></li>
                            <li><Link className="hover:text-golden" href="/category">Products</Link></li>
                            <li><Link className="hover:text-golden" href="/contact">Contact Us</Link></li>
                        </ul>
                        ...
                        <div className="hidden xl:flex items-center space-x-5 items-center">
                            ...
                            <Link className="flex items-center hover:text-golden" href="/login">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 hover:text-golden" fill="none" viewBox="0 0 24 24" stroke="currentColor">
